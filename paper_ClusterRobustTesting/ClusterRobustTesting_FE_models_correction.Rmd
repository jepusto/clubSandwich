...
# si_ols_absorb <- mapply(\(x,e) sum(x * e), x = emat_ols_absorb, e = split(residuals(ols_absorbed), clust))
...
# si_wt_full <- mapply(\(x,e) sum(x * e), x = emat_wt_full, e = split(residuals(wls_fit), clust))
...
# si_wt_absorb <- mapply(\(x,e) sum(x * e), x = emat_wt_absorb, e = split(residuals(wls_absorbed), clust))
