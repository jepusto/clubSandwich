...
subset(rbind(RWA, V_comp), select = -ols_absorb) |>
  kable(
    caption = "Adjustment matrices based on weighted or unweighted least squares",
    col.names = c("Cluster", "Y", "Full", "Absorbed", "Full/Absorbed"),
    digits = 3, 
    booktabs = TRUE,
    escape = FALSE
  ) |>
  ...
  add_header_above(c(" " = 2, "Weighted" = 2, "Unweighted" = 1)) |>
