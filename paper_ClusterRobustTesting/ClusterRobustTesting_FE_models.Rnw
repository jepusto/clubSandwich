...
%\SweaveOpts{concordance=TRUE}
=======
>>>>>>> f09547c1e2555d28f94c6500b9277389a906fa81
...
By adjusting the degrees of freedom to account for these features, the Type I error rate of the test is nearly-always less than or equal to nominal, so long as the degrees of freedom are larger than 4 or 5 (Bell & McCaffrey, 2002; Tipton, 2015).
