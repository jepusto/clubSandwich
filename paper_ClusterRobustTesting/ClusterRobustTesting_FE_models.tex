...
Letting $h = 1,2,3$ index the sector of each school (Arab religious, Jewish religious, or Jewish secular), we
posit the following analytic model: 
\begin{equation}
\label{eq:AL_ATE}
