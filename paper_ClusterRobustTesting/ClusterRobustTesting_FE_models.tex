...
Each combination of sample sizes and parameter levels was simulated for balanced and unbalanced versions of each of the three study designs, yielding a total of 648 simulation conditions.
...
Although there exist situations in which the error is above the simulation bound, the departures are typically small. For example, when $m = 15$ the rejection rates do not exceed 0.007 for $\alpha = .01$, 0.013 for $\alpha = .05$, and 0.055 for $\alpha = .10$.
