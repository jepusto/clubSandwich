...
$$
for $j=1,...,J$, where $\bmat{A}_1,...,\bmat{A}_J$ are adjustment matrices that satisfy the criteria
$$
...
The cluster-level jackknife technique is closely related to cluster-robust variance estimation. The cluster-level jack-knife 
Estimating the sampling variance of $\bs{\hat\beta}$ using a cluster-level jack-knife is closely related to using
