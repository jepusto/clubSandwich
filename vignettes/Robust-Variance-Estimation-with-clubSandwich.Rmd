...
$$
\bmat{B}_j = \bmat{D}_j \left(\bs\Psi_j - \bmat{X}_{j}\bmat{M}\bmat{X}_{j}'\right)\bmat{D}_j'.
$$
<!-- H: If we describe B_j, I think it would be clearer to use X_j's instead of full X's inside. -->
