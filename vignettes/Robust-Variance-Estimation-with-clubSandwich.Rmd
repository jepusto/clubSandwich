...
(\#eq:V-CR)
$$
for some constant $f$ and some estimating matrices $\bmat{E}_1,...,\bmat{E}_J$. With this representation, the CRO estimator corresponds to $f_0 = 1$ and $\bmat{E}^\sb{0}_j = \bmat{W}_j \bmat{X}_j$.
