...
<!-- H: Why don't we explain the "trick" of Niccodemi et al. (2020)? The gist of it would be of course its equation (6), but let's not go there... Instead, let's explain part of the followings. <- Add a footnote with just the X_j^* and equation (6), E_j. -->
