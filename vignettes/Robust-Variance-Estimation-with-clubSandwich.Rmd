...
1) We can set $\bmat{X}^*_j = \bmat{W}^C_j \bmat{X}_j$ (and $\bmat{Y}^*_j = \bmat{W}^C_j \bmat{Y}_j$) following @cameron2015practitioner (and other references) when $\bmat{W}_j = \bs\Psi_j^{-1}$ for WLS cases using CR2f.
